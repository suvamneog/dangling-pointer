...
SCHEME="DanglingPointer"
APP_NAME="DanglingPointer"
...
SPARKLE_BIN=$(find ~/Library/Developer/Xcode/DerivedData/DanglingPointer*/SourcePackages/artifacts/sparkle/Sparkle/bin -maxdepth 0 2>/dev/null | head -1)
