//
//  DanglingPointerAnalytics.swift
//  DanglingPointer
//
...
enum DanglingPointerAnalytics {

    // MARK: - Setup

    /// Analytics are disabled in this build: the original PostHog project key
    /// belongs to the upstream project and would send your usage (including spoken
    /// responses) to their dashboard. PostHogSDK calls are no-ops until setup.
    ...
    /// The 40s onboarding demo interaction where the buddy points at something.
